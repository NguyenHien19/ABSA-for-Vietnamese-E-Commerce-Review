...
def main():
    ...
    dataset_files = {
        'ViSFD': {
            'train': './dataset/UIT-ViSFD/train_write.json',
            'test': './dataset/UIT-ViSFD/test_write.json',
        },
        'ViSD4SA': {
            'train': './dataset/UIT-ViSD4SA/train_write.json',
            'test': './dataset/UIT-ViSD4SA/test_write.json',
        },
    }
